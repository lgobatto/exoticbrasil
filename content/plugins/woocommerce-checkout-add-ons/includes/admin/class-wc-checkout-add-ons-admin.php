					...
					<thead>
						<tr>
							...
							<th class="wc-checkout-add-on-options-costs">
								...
								<?php echo wc_help_tip( __( 'Use Pipe (|) to separate options and surround options with double stars (**) to set as a default. To set a price for an option, append it to the option with an equation mark. Example: Yes=5.00|No', 'woocommerce-checkout-add-ons' ) ); ?>
							</th>
