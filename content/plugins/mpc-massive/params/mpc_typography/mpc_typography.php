...
function mpc_get_typography_form() {
	...
	<div id="mpc_typography_form" class="mpc-typography-form">
		...
		<div class="mpc-preview-wrap">
			<div class="mpc-preview">
				<span class="mpc-line"><?php _e( 'The quick brown fox jumps over the lazy dog.', 'mpc' ); ?></span>
				<span class="mpc-line">1 2 3 4 5 6 7 8 9 0 ? ! . , ( ) [ ] @ # % ^ & * ; : ' "</span>
			</div>
		</div>
	...
	<script>
		var _mpc_fonts = <?php require_once( mpc_get_google_webfonts() ); ?>;
	</script>
	<?php
