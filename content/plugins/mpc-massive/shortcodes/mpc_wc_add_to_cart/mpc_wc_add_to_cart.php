		...
		function shortcode_template( $atts, $content = null, $shortcode = null, $parent_css = null ) {
			...
			if( isset( $this->atts[ 'item_id' ] )  && (int) $this->atts[ 'item_id' ]) {
				...
				if( $product->product_type == 'variation' ) {
					$data_cart = ' data-cart=\'' . json_encode( array( 'product_id' => $this->atts[ 'item_id' ], 'variation_id' => $product->variation_id ) ) . '\'';
				} else if( !in_array( $product->product_type, array( 'external', 'variable' ) ) ) {
