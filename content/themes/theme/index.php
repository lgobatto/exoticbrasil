        ...
        <div class="content_wrapper clearfix">
            ...
            <div class="sections_group">
                ...
                <div class="extra_content">
					<?php
					if ( get_option( 'page_for_posts' ) || mfn_opts_get( 'blog-page' ) || is_archive() ) {
						echo '<div class="section the_content category_description">';
						echo '<div class="section_wrapper">';
						echo '<div class="the_content_wrapper">';
						printf( '<h1 class="themecolor">%s</h1>', get_queried_object()->name );
						printf( '<p>%s</p>', get_queried_object()->description   );
						echo '<hr></div>';
						echo '</div>';
						echo '</div>';
